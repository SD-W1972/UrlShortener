...
public class ClickTest {
    ...
    public void shouldCreateValidClick(){
        ...
        assertNotNull(click);
        assertEquals("https://example.com", click.getUrl());
        ...
        assertThat(click.getCreatedAt()).isAfter(before);
        assertThat(click.getCreatedAt()).isBefore(after);
    }

    @Test
    public void shouldThrowAnExceptionWhenOriginalUrlIsNull(){
        Assertions.assertThrows(IllegalArgumentException.class, () ->
                new Click(null, "abc123", () -> LocalDateTime.now(),
